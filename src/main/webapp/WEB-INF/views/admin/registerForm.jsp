...
<main id="main" class="main">
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col">
                <div class="mb-4 pt-4">
                    <form:form method="post" modelAttribute="userForm" action="/admin/user/save">
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <spring:bind path="clinic">
                                                ...
                                                <form:select path="clinic" id="clinic"
                                                             class="form-select mb-0 ${status.error ? 'is-invalid' : ''}"
                                                ...
                                                <form:errors path="clinic" id="validationClinicFeedback"
                                                             class="invalid-feedback"/>
                                            </spring:bind>
                                        </div>
                                    </div>
