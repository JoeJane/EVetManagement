...
<main id="main" class="main">
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col">
                <div class="mb-4 pt-4">
                    <form:form method="post" modelAttribute="userForm" action="/labassistant/save">
                                                        ...
                                                        <td>
                                                            <c:choose>
                                                                <c:when test="${booking.status == 'CANCELED'}">
                                                                    <a class="align-items-center ms-3 disable-a" disabled="true"
                                                                       ...
                                                                       title="Download Report"><i class="fa-solid fa-circle-up"></i></a>
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <a class="align-items-center ms-3"
                                                                       href="/labassistant/uploadreport/${booking.id}"
                                                                       title="Upload Report"><i class="fa-solid fa-circle-up"></i></a>
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${booking.report.id != null}">
                                                                    <a class="align-items-center ms-3"
                                                                       href="/labassistant/downloadFile/${booking.report.id}"
