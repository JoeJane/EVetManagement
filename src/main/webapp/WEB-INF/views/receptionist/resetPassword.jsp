...
<main id="main" class="main">
    <div class="container py-4">
        <div class="row justify-content-center form-bg-image">
            <p class="text-center">
                <a href="/labassistant/home" class="d-flex align-items-center justify-content-center">
                    <i class="fa-solid fa-arrow-left-long"></i>&nbsp; Back</a>
            </p>
            <form:form method="post" action="/receptionist/resetPassword" modelAttribute="userForm">
