...
<main id="main" class="main">
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col">
                <div class="mb-4 pt-4">
                    <form:form method="post" modelAttribute="userForm" action="/owner/save">
                                                                ...
                                                                <c:choose>
                                                                    <c:when test="${booking.status == 'COMPLETED'}">
                                                                        <a class="align-items-center"
                                                                           href="/user/view-prescription/${booking.id}"
                                                                ...
                                                                <c:choose>
                                                                    <c:when test="${booking.report.id != null}">
                                                                        <a class="align-items-center ms-3"
                                                                           href="/user/downloadFile/${booking.report.id}"
                        ...
                        <div class="float-end">
                            <a href="/user/home" class="fw-bold mx-2"><< Back</a>
                        </div>
                </div>
            </div>
