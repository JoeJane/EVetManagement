                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1">
                                ...
                                <c:choose>
                                <c:when test="${pet.latestAppointment.status == 'NEW' && vetId == pet.latestAppointment.veterinarian.userId}">
                                    <a class="dropdown-item d-flex align-items-center" href="writeprescription/${pet.id}"><i class="fa-solid fa-pen-to-square"></i> Prescribe Medicine </a>
                                </c:when>
                                </c:choose>
                            </div>
                        </div>
...
<script>
    ...
    $('#close-btn').click(function (){
        window.location.href = "/veterinarian/home";
    });
