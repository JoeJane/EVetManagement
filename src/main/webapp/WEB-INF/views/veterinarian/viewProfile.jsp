...
<main id="main" class="main">
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col">
                <div class="mb-4 pt-4">
                    <form:form method="post" modelAttribute="userForm" action="/veterinarian">
                        ...
                        <div class="float-end">
                            ...
                            <a href="/veterinarian/edit" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">Edit</a>
                        </div>
                    </form:form>
                </div>
            </div>
